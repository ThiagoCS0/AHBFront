...
export default function ComCabecalho() {
    ...
    },
    {
      ...
      "metodos": {
        "get": [
          {
            "titulo": "Buscar CEP",
            "url": "https://buscarcep.com.br/?cep=(CEP [ex.: 57020440 (Maceió)])&chave=(SUA_CHAVE [ex.: Chave_Gratuita_BuscarCep]",
            "header": "",
            "body": "",
            "token": true
          },
        ...
        "get": [
          {
            ...
            "url": "https://api.invertexto.com/v1/barcode?token=(SEU_TOKEN)&text=exemplo&type=code39&font=arial",
            "header": "",
            "body": "",
            "token": true
          }, {
            "titulo": "Gerador de Pessoas",
            "url": "https://api.invertexto.com/v1/faker?token=(SEU_TOKEN)&fields=name,cpf&locale=pt_BR",
            "header": "",
            "body": "",
            "token": true
          }, {
            "titulo": "Localizador de IP",
            "url": "https://api.invertexto.com/v1/geoip/200.33.152.248?token=(SEU_TOKEN)",
            "header": "",
            "body": "",
            "token": true
          }, {
            "titulo": "Validador de CPF e CNPJ",
            "url": "https://api.invertexto.com/v1/validator?token=(SEU_TOKEN)&value=(CPF_ou_CNPJ [ex.: 12345678909])",
            "header": "",
            "body": "",
            "token": true
          }, {
            "titulo": "Conversor de Moedas",
            "url": "https://api.invertexto.com/v1/currency/USD_BRL?token=(SEU_TOKEN)",
            "header": "",
            "body": "",
            "token": true
          }, {
            "titulo": "Validador de Email",
            "url": "https://api.invertexto.com/v1/email-validator/email@example.com?token=(SEU_TOKEN)",
            "header": "",
            "body": "",
            "token": true
          }
  ...
  const [ultimos_estado_backend, def_ultimos_estado_backend] = useState("");
